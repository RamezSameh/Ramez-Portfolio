...
const translations = {
  en: {
    ...
    home: {
      ...
      heroTitle: 'Turning complex', heroOutline: 'systems', heroMiddle: 'into', heroAccent: 'clear experiences.',
      ...
      portraitCaption: 'Full Stack Developer', contextEyebrow: 'A little context', context: "I'm a developer who enjoys finding the calm inside complicated systems — then turning it into a product people can use without thinking twice.", based: 'Based in Cairo, building for anywhere.',
  ...
  ar: {
    ...
    home: {
      ...
      heroTitle: 'أحوّل الأنظمة', heroOutline: 'المعقدة', heroMiddle: 'إلى', heroAccent: 'تجارب واضحة.',
      ...
      portraitCaption: 'مطور Full Stack', contextEyebrow: 'نبذة سريعة', context: 'أستمتع بالعثور على الهدوء داخل الأنظمة المعقدة، ثم تحويله إلى منتج يمكن استخدامه بسهولة ودون تفكير زائد.', based: 'من القاهرة، وأبني منتجات للعالم.',
