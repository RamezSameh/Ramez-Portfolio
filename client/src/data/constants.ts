...
export const projects = [
  ...
  },
  {
    ...
    number: '04',
    name: 'Portfolio',
    nameAr: 'السيرة الذاتية', eyebrowAr: 'معرض الأعمال', descriptionAr: 'معرض لمشاريعي وخبراتي المهنية.', longDescriptionAr: 'معرض شامل لمشاريعي وخبراتي المهنية، يوضح قدراتي وتجاربي في مجال تطوير البرمجيات.',
    eyebrow: 'Portfolio',
    description: 'A showcase of my projects and professional experience.',
    longDescription: 'A comprehensive portfolio highlighting my projects and professional experience, demonstrating my skills and expertise in software development.',
    technologies: ['Angular', 'TypeScript', 'HTML', 'CSS'],
    tags: ['N-Tier', 'DevOps Ready'],
    github: 'https://github.com/RamezSameh/Ramez-Portfolio',
    repo: 'RamezSameh/Ramez-Portfolio',
    image: '../../Pics/PortfolioImg/Portfolio1.png',
    gallery: ['../../Pics/PortfolioImg/Portfolio1.png',
      '../../Pics/PortfolioImg/Portfolio2.png',
      '../../Pics/PortfolioImg/Portfolio3.png',
      '../../Pics/PortfolioImg/Portfolio4.png'],
    stars: 0,
    accent: 'cyan',
  },
];
